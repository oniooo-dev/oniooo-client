...
const MochiBanner: React.FC<MochiBannerProps> = ({ name, price, amount }) => {
	return (
		<div className="flex-vertical p-1 bg-gradient-to-r from-red-400 to-pink-300 text-transparent rounded-xl w-full h-full hover:scale-[1.01] cursor-pointer duration-500">
